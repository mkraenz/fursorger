...
export class LoadingScene extends Scene {
    ...
    private preloadAllAssets() {
        ...
        this.load
            ...
            .image("shop0", imgPath("shop.png"))
            .image("shop1", imgPath("shop2.svg"))
            .image("shop2", imgPath("shop3.svg"))
            .image("shop3", imgPath("shop4.svg"))
            .image("shop4", imgPath("shop5.svg"))
            .image("shop5", imgPath("shop6.svg"))
            .image("shop6", imgPath("shop7.svg"))
            .image("shop7", imgPath("shop8.svg"))
